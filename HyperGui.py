...
def main():
    (window, introduction, input_output, image_diagram, hist_calculation, spec_calculation, bp, crop, bs, measure, mda, mda2, circle, rectangle, spec_invest, prediction) = init()
