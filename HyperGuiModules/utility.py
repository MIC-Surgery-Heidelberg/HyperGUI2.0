...
def init():
    ...
    prediction = Frame(notebook, bg=tkcolour_from_rgb(WHITE))
    prediction.pack()
    notebook.add(prediction, text="Prediction")
    
    notebook.pack()

    return root, introduction, input_output, image_diagram, hist_calculation, spec_calculation, BP, crops, BS, measure, mda, mda2, circle, rectangle, specInvest, prediction
